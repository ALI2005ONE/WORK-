        ...
        <div className="flex justify-between h-16 rtl:flex-row-reverse">
          <div className="flex items-center">
            ...
            >
              ...
              <span className="font-bold text-xl text-gray-900 main-text">
                التعلم الإسلامي
              </span>
            </Link>
          </div>
            ...
            {state.isAuthenticated ? (
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56" align="end">
                    <DropdownMenuItem asChild>
                      <Link
                        href="/profile"
                        className="flex items-center main-text"
                      >
              ...
              <div className="flex items-center space-x-2 rtl:space-x-reverse">
                <Button variant="ghost" asChild>
                  <Link href="/auth/login" className="main-text">
                    تسجيل الدخول
                  </Link>
                </Button>
                <Button asChild>
                  <Link href="/auth/register" className="main-text">
                    إنشاء حساب
                  </Link>
                </Button>
              </div>
